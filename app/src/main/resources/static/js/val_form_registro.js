...
validation = (form_box, boxInput) =>{
    ...
    };//Validación de que el password ingresado contenga más de 6 carácteres.
...
sumitController = () =>{
    console.log(errors);
    if(errors.nickName || errors.apellido || errors.email || errors.password || errors.confirmPass){
